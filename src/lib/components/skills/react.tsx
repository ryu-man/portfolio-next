    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col text-primary-foreground">
        ...
        <ul className="flex flex-col gap-2 list-disc list-inside">
          ...
          <li>Integrate and work with UI libraries like Chadcn and bitsUI</li>
          <li>
            Create reusable UI components, with focus on custimizability,
            scalability and composition using CSS and CSS libraries like
            TailwindCSS, context API and Snippets (Slots in older versions).
          </li>
        </ul>
      </div>
